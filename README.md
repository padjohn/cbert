...
CausalBERT is a specialized natural language processing model designed to extract causal relationships (CAUSE, EFFECT, INTERDEPENDENCY) from German text. Built upon a Transformer architecture, this model is fine-tuned to perform two key tasks:
